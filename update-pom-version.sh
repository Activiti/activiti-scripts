...
for DEP in '' activiti activiti-cloud-service-common activiti-cloud-runtime-bundle activiti-cloud-audit activiti-cloud-query activiti-cloud-connectors activiti-cloud-process-model activiti-cloud-org
do
  [ -n "$DEP" ] && TAG="${DEP}."
  TAG="${TAG}version"
